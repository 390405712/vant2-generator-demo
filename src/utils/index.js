export function getSpanArr(data, mergedColumns) {
  const spanMap = {}
...
export function objectSpanMethod(cell, spanMap) {
...
export function BlobDownload(res, headers) {
...
export function getDateScope(start, end) {
  let dateArr = [];
...
export function getDefaultDateScope(total) {
