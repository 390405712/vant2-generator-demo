    ...
    formOption: [
      ...
      },
      {
        ...
        control: {
          ...
          leftIcon: 'smile-o',
          rightIcon: 'warning-o',
          'onUpdate:modelValue': (value) => { console.log(`update:model-value:${value}`) },
          ...
          onClickInput: (event) => { console.log(`click-input:${event}`) },
          onClickLeftIcon: (event) => { console.log(`click-left-icon:${event}`) },
          onClickRightIcon: (event) => { console.log(`click-right-icon:${event}`) },
          onStartValidate: () => { console.log(`start-validate`) },
          onEndValidate: (status) => { console.log(`end-validate:${status}`) },
        }
      },
      {
        type: 'field',
      ...
      },
      {
        ...
        control: {
          'onUpdate:modelValue': (value) => { form.value.key20 = `${value.replace('改写值', '')}改写值` },
        }
      },
    ],
  }),
